        ...
        <div class="container">
            <div class="row">
             ...
             if(isset($_POST["submit"])){
              ...
              if(empty($Uname) OR empty($email)  OR empty($dropdown) OR empty($message)){
             ...
             foreach($errors as $error){
              echo "<div id='error-message' class='alert alert-danger'>$error</div>";
             }
            ...
            $sql = "INSERT INTO enquiry (Username, email, dropdown, message) VALUES (?,?,?,?)";
            $stmt = mysqli_stmt_init($conn);
            
            if($stmt && mysqli_stmt_prepare($stmt,$sql)){
              mysqli_stmt_bind_param($stmt,"ssss",$Uname,$email,$dropdown,$message);

              if(mysqli_stmt_execute($stmt)){
                 echo "<div id='success-alert' class='alert alert-success'>Registered We Will contact You...</div>";
              }else{
                echo "<div id='error-alert' class='alert alert-danger'>Failed to Registered</div>";
              }
            }else{
              echo "<div id='error-alert' class='alert alert-danger'>Something Went Wrong</div>";
            }
            echo "<script>
                   setTimeout(function() {
          ...
          ?>   
                    ...
                    <form action="./Enquiry.php" method="post">
                        <div class="mb-2">
                          <label for="exampleInputusername1" class="form-label text-dark fs-4 fw-semibold Enq-detail">Name</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Uname"> 
                        </div>
                        <div class="mb-4">
                            <label for="exampleInputEmail1" class="form-label text-dark fs-4 fw-semibold Enq-detail">Email</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email">
                            <div id="emailHelp" class="form-text text-success">We'll never share your email with anyone else.</div>
                        </div>
                        <div class="mb-4">
                            <label for="exampleInputproduct1" class="form-label text-dark fs-4 fw-semibold Enq-detail">Select Product</label>
                            <select class="form-select" aria-label="Default select example" name="dropdown">
                                ...
                                <option value="Fully Husked Coconut">Fully Husked Coconut</option>
                                <option value="Coconut Charcoal">Coconut Charcoal</option>
                                <option value="Coir Disk">Coir Disk</option>
                                <option value="Coir Blocks">Coir Blocks</option>
                                <option value="Peat Blocks">Peat Blocks</option>
                                <option value="Coir Bales">Coir Bales</option>
                                <option value="Coir Fibre">Coir Fibre</option>
                              </select>
                        </div>
                        <div class="mb-4">
                          <label for="exampleInputPassword1" class="form-label text-dark fs-4 fw-semibold Enq-detail">Message</label>
                  ...
                  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="./coconut-1000x1000.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item"> 
                        <img src="./fully husked cocunut.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="./semi-husked-coconuts-500x500.webp" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="./cocunut  charcoal.webp" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="./coco-peat-disc-.webp" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="./peat-block-500x500.webp" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="./coconut-husk-fiber-500x500.webp" class="d-block w-100" alt="...">
                      </div>
                    </div>
