...
<!--login section-->
<section class="login py-3 mb-5">
    <div class="container">
        <div class="row g-0 login-row">
            <div class="col-lg-5">
                <img src="./adminimage (2).jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-7 text-center py-5 mt-5">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(mysqli_num_rows($res)){
      ...
      // If no matching record or incorrect password, display error message
      echo "<div id='error-alert' class='alert alert-success'>Username and Password invalid</div>";
      echo "<script>
              setTimeout(function() {
...
?>
             ...
             <!--Login php ends-->
                ...
                <h1 class="animate_animated animate__heartBeat ">Admin Login</h1>
                <form class="mb-3" action='Admin_Login.php' method='post'>
