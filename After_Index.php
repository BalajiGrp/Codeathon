        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 ms-3 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle nav-link active ms-3 fs-5 fw-normal " data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Welcome</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item fs-5 fw-normal hover-underline-animation" href="#">Order Details</a></li>
                <li><a class="dropdown-item fs-5 fw-normal hover-underline-animation text-danger" href="UserLogout.php">Logout</a></li>
              </ul>
            </li>
          </ul>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="text-center mb-3">
                <a href="order.php" class="fs-4 text-decoration-none btn btn-success"><i class="bi bi-bag-check"></i> Place Order</a>
              </div>
            </div>
          </div>
      </div>
